...
session_start();
if(!empty($_SESSION['usenam']) and !empty($_SESSION['p'])) //checking the 'user' name which is from profile.php, is it empty or have some text 
{ 
	$query = mysql_query("SELECT * FROM websiteusers where userName = '$_SESSION[usenam]' AND pass = '$_SESSION[p]' ") or die(mysql_error()); 
